      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden">
          ...
          <div className="flex justify-center mt-10">
            <a
              href="/our-story"
              className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium text-[#0a1f4a] transition-all duration-300 ease-out border-2 border-[#0a1f4a] rounded-none shadow-lg hover:scale-105 hover:shadow-[#0a1f4a] hover:shadow-lg active:scale-95 bg-transparent hover:bg-[#0a1f4a] hover:text-white"
        ...
        {/* Desktop CTA Button */}
        <div className="hidden lg:flex justify-start mt-12 lg:pl-16">
          <a
            href="/our-story"
            className="group relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-medium text-[#0a1f4a] transition-all duration-300 ease-out border-2 border-[#0a1f4a] rounded-none shadow-lg hover:scale-105 hover:shadow-[#0a1f4a] hover:shadow-lg active:scale-95 bg-transparent hover:bg-[#0a1f4a] hover:text-white"
            aria-label="Our Story"
