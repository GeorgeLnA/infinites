          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                       ...
                       <span className="text-sm text-white/70">Miami, FL</span>
              </div>
              <div className="flex items-center space-x-3">
                                       <Phone className="w-4 h-4 text-white/60" />
                       <span className="text-sm text-white/70">+1 (208) 709-7720</span>
              </div>
              <div className="flex items-center space-x-3">
                                       <Mail className="w-4 h-4 text-white/60" />
                       <span className="text-sm text-white/70">info@infinitespa.co</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex space-x-3">
                ...
                >
                  <svg className="w-4 h-4" style={{ color: '#0b1c26' }} fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center space-x-4 text-sm text-white/50">
              <span>🇺🇸 Miami, FL</span>
              <span>© 2025 Infinite Communities</span>
            </div>
          </div>
        </div>
