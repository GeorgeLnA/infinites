        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
          <div className="text-center">
            ...
            <div className="mt-4 sm:mt-6 lg:mt-8 flex justify-center">
              <a href="/booking" className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 overflow-hidden font-medium text-white transition-all duration-300 ease-out border-2 border-white rounded-none shadow-2xl hover:scale-105 hover:shadow-white hover:shadow-2xl active:scale-95">
